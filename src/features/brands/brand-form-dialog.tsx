      ...
      <DialogBody>
        <FieldGroup className="py-1">
          ...
          <ImageSlotField
            field="logo"
            label="Logo"
            existingUrl={brand?.logoUrl}
            existingObjectKey={brand?.logoObjectKey}
            error={fieldErrors?.logoObjectKey}
            description="PNG, JPEG or SVG. Uploaded when you save, so cancelling leaves nothing behind."
            disabled={busy}
          />
